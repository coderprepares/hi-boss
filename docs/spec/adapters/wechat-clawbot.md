...
4. Sidecar sends text via `sendmessage` after mapping CR/LF to `U+2028` for WeChat display; image/video/file attachments are AES-encrypted and sent as iLink CDN media items.
